package com.github.knightliao.canalx.rest.client.core.selector.impl;
...
public class RandomServiceSelector implements ServiceSelector {
    ...
    private void printErrMessage(Throwable e) {
        ...
        String errMsg =
                "Rest invoke error,Target=[" + method.getDeclaringClass().getCanonicalName() + "#" + method.getName() +
                        "()], oe=[" + baseCause.getClass().getCanonicalName() + "], om=[" + baseCause.getMessage()
                        + "], de=[" +
